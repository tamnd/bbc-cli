...
Most of these come down to network reality or how bbc serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

bbc rate-limits like any public site. bbc already paces
...
Where a surface is gated, bbc reads a cookie or token you supply
...
`bbc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what bbc actually did
