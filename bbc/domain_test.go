...
// HTTP behaviour is covered in bbc_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "bbc://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("bbc", "about")
	if err != nil || got.String() != "bbc://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want bbc://page/about", got.String(), err)
	}
}
